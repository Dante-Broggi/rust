...
use rustc_target::abi::{Abi, HasDataLayout, Integer, MemoryLayout, TagEncoding};
...
fn trait_pointer_metadata(
    ...
    let member_descriptions = vec![
        MemberDescription {
            ...
            layout: data_ptr_field.memory_layout(),
        ...
        MemberDescription {
            ...
            layout: vtable_field.memory_layout(),
            flags: DIFlags::FlagArtificial,
            discriminant: None,
            source_info: None,
        },
    ...
    fn into_metadata(
        ...
        unsafe {
            llvm::LLVMRustDIBuilderCreateVariantMemberType(
                ...
                file,
                line,
                self.layout.size.bits(),
                self.layout.align.bits() as u32,
                self.offset.bits(),
        ...
        match self.layout.variants {
            Variants::Single { index } => {
                ...
                vec![MemberDescription {
                    ...
                    offset: Size::ZERO,
                    layout: self.layout.memory_layout(),
                    flags: DIFlags::FlagZero,
                    discriminant: None,
